...
for item in items:
    ...
    if init == 'U' or init == 'V' or init == 'W':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\UVW\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\UVW\\' + tpath_mongo
