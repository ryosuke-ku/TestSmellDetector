...
cnt = 0
num = 0
file = open('mongoInfo_QRST.csv','w')
...
for item in items:
    ...
    if init == 'Q' or init == 'R' or init == 'S' or init == 'T':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\QRST\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\QRST\\' + tpath_mongo
