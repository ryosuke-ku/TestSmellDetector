...
for item in items:
    ...
    if init == 'X' or init == 'Y' or init == 'Z':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\XYZ\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\XYZ\\' + tpath_mongo
