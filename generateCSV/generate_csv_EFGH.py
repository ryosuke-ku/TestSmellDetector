...
for item in items:
    ...
    if init == 'E' or init == 'F' or init == 'G' or init == 'H':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\EFGH\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\EFGH\\' + tpath_mongo
