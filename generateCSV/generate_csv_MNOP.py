...
cnt = 0
num = 0
file = open('mongoInfo_MNOP.csv','w')
...
for item in items:
    ...
    if init == 'M' or init == 'N' or init == 'O' or init == 'P':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\MNOP\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\MNOP\\' + tpath_mongo
