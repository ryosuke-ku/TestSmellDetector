...
cnt = 0
num = 0
file = open('mongoInfo_ABCD.csv','w')
...
for item in items:
    ...
    if init == 'A' or init == 'B' or init == 'C' or init == 'D':
        ppath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\ABCD\\' + ppath_mongo
        tpath = 'D:\\ryosuke-ku\\data_set\\Git_20161108\\ABCD\\' + tpath_mongo
        # writer.writerow([project_name, ppath, tpath])
        print('ppath : ' + ppath + ' , ' + 'tpath : ' + tpath)
